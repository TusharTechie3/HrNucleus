      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">HR Nucleus</h2>
            <div style={{margin:"5px 1px", textDecoration:"underline"}}>
              <p className="text-sm">Unit 805,8th floor,</p>
              <p className="text-sm">Vipul Business Park, Sector 48,</p>
              <p className="text-sm">Gurgaon,Sohna Road, Haryana -122018</p>
            </div>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://www.linkedin.com/in/hr-nucleus-22170113a/" className="hover:text-gray-400" aria-label="LinkedIn">
