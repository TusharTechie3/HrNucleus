      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start">
          ...
          <div className="mb-6 md:mb-0 text-center md:text-left">
            <h2 className="text-2xl font-semibold mb-2">HR Nucleus</h2>
            <div className="text-sm mb-4">
              <p>Unit 805, 8th floor,</p>
              <p>Vipul Business Park, Sector 48,</p>
              <p>Gurgaon, Sohna Road, Haryana -122018</p>
            </div>
            <p className="text-sm">© 2024 HR Nucleus. All rights reserved.</p>
          </div>
          ...
          <div className="flex space-x-6 mt-4 md:mt-0 justify-center md:justify-start">
            ...
            <a href="https://www.linkedin.com/in/hr-nucleus-22170113a/" className="text-gray-600 hover:text-gray-800" aria-label="LinkedIn">
