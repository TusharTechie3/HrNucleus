...
const Browse = () => {
    const {searchObj}=useContext(GlobalContext);   
    ...
    return (
        <div>
            ...
            <div className='max-w-7xl mx-auto my-10'>
                <h1 className='font-bold text-xl my-10'>Search Results ({searchResult.length}) : {searchObj.keyword}{searchObj.location && `, ${searchObj.location}`} </h1>
